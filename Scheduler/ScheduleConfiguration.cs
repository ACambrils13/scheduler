...
namespace Scheduler
{
    ...
    {
        readonly Scheduler scheduleProperties;
        public ScheduleConfigurator(Scheduler ScheduleProperties) 
        {
            ScheduleConfigValidator.ValidateDateNullable(ScheduleProperties.CurrentDate, nameof(ScheduleProperties.CurrentDate));
